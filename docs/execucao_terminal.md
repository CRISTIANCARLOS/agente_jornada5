...
> **User:** "Qual a média de tempo de G2G da BAERI em julho de 2026?"

Você verá no log o Orquestrador roteando para o `SA1_tempo_g2g` e acionando as funções do BigQuery antes de devolver a resposta.
